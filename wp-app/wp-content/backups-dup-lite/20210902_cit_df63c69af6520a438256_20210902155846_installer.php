...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210902_cit_df63c69af6520a438256_20210902155846_archive.zip';
	const ARCHIVE_SIZE		 = '54063585';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'df63c69-02155846';
    const SECONDARY_PACKAGE_HASH = 'f838765-02155846';
	const VERSION			 = '1.4.2';
