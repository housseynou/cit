...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210902_cit_917aa241209cec998972_20210926121707_archive.zip';
	const ARCHIVE_SIZE		 = '54219988';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '917aa24-26121707';
    const SECONDARY_PACKAGE_HASH = '0c5e6a0-26121707';
	const VERSION			 = '1.4.2';
